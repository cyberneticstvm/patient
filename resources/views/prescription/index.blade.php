...
<section class="content-main">
    <div class="content-header">
        <div>
            ...
            <p><p>Hello, {{ Session::get('patient')->patient_name }}</p></p>
        </div>
        @include("message")
    </div>
    <div class="row">
                ...
                <table id="dataTable" class="table table-sm table-striped">
                    <thead><tr><th>SL No<th>Medical Record No</th><th>Date</th><th>View/Download</th></tr></thead><tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><a href="{{ route('prescription.pdf', encrypt($item->id)) }}" target="_blank"><i class="fa fa-file"></i></a></td>
                        </tr>
                        @empty
                        @endforelse
                    </tbody>
